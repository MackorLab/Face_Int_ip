...
def load_models():
    ...
    pipe = DiffusionPipeline.from_pretrained("DmatryMakeev/ponteleich-v3", torch_dtype=torch.float16, scheduler=noise_scheduler, vae=vae, feature_extractor=None, safety_checker=None)
    pipe.to(device)
